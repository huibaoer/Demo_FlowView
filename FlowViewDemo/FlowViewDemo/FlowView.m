...
- (void)reloadData {
    ...
    for (int i = 0; i < self.imageViews.count; i++) {
        ...
        imageView.frame = CGRectMake(i*self.pageSize.width, 0, self.pageSize.width, self.pageSize.height);
...
- (void)setImageScaleWithContentOffset:(CGPoint)offset {
    ...
    for (NSInteger i = 0; i < self.imageViews.count; i++) {
        ...
        CGRect originFrame = CGRectMake(_pageSize.width * i, 0, _pageSize.width, _pageSize.height);
